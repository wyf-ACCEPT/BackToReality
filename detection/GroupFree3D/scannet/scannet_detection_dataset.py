...
class ScannetDetectionDataset(Dataset):
    ...
    def __init__(self, split_set='train', data_path="scannet_train_detection_data_md40", num_points=20000,
        ...
        if data_path == "scannet_train_detection_data":
            filename = os.path.join(f'scannet/{split_set}_data.pkl')
        elif data_path == "scannet_train_detection_data_md40":
            filename = os.path.join(f'scannet/{split_set}_data_md40.pkl')
        elif data_path == "scannet_train_detection_data_md40_obj_mesh":
            filename = os.path.join(f'scannet/{split_set}_data_md40_obj.pkl')
        elif data_path == "scannet_train_detection_data_md40_obj":
            filename = os.path.join(f'scannet/{split_set}_data_md40_obj_womesh.pkl')
        elif data_path == "scannet_train_detection_data_md40_obj_mesh_aug":
            filename = os.path.join(f'scannet/{split_set}_data_md40_obj_aug.pkl')
        elif data_path == "scannet_train_detection_data_md40_obj_aug":
            filename = os.path.join(f'scannet/{split_set}_data_md40_obj_womesh_aug.pkl')
        else:
            raise RuntimeError(F"no dataset {data_path}.")
