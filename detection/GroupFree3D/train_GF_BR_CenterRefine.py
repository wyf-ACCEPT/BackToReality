...
from models import GroupFreeDetector_DA_jitter, get_loss_DA_jitter
...
def train_one_epoch(epoch, train_loader_S, train_loader_T, DATASET_CONFIG, model, criterion, optimizer, scheduler, config):
...
def evaluate_one_epoch(test_loader_S, test_loader_T, DATASET_CONFIG, CONFIG_DICT, AP_IOU_THRESHOLDS, model, criterion, config):
    stat_dict = {}
