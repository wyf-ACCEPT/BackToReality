...
import os
# os.environ["CDA_VISIBLE_DEVICES"] = '1'
...
parser.add_argument('--log_dir', default='log_scannet_DA_jitter', help='Dump dir to save model checkpoint [default: log_scannet_DA]')
...
if FLAGS.model == 'boxnet':
    ...
    Detector = MODEL.VoteNet_DA_jitter
...
net.to(device)
criterion = MODEL.get_loss_DA_jitter
