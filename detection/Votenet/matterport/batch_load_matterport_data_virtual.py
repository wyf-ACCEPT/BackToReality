...
import datetime
import numpy as np
sys.path.append("../../../data_generation/Matterport3D")
from matterport_scene_synthesis import export_for_md40
import pdb

MATTERPORT_DIR = 'scans'
TRAIN_SCAN_NAMES = [sname[:-4] for sname in os.listdir('./augment_random_positions_matterport')]
LABEL_MAP_FILE = 'meta_data/category_mapping.tsv'
DONOTCARE_CLASS_IDS = np.array([])
OBJ_CLASS_IDS = np.array([2,3,4,9,12,13,14,15,24,31,33,34,36])
MAX_NUM_POINT = 50000
OUTPUT_FOLDER = './matterport_train_detection_data_md40_obj_aug'
