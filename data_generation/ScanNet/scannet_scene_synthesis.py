...
if __name__ == "__main__":
    ...
    for scan_name in scan_names:
        print(scan_name)
        scan_folder = "/path/to/scannet/scans/" + scan_name + "/"
        ...
        np.save('/path/to/BackToReality/data_generation/ScanNet/augment_random_positions_scannet/' + scan_name + '.npy', positions)
    ...
    for d in dset:
        ...
        for aug_idx in range(2):
            ...
            np.save('/path/to/BackToReality/data_generation/ScanNet/augment_random_positions_scannet/' + aug_scan_name + '.npy', positions_aug)
